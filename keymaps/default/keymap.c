...
[1] = LAYOUT_ergodox_pretty(
  ...
  KC_DEL,       KC_SCLN,    KC_COMM,    KC_DOT, KC_P,    KC_Y,    KC_TRNS,          KC_TRNS,    KC_F,       KC_G,       KC_C,       KC_R,       KC_L,       KC_TRNS,
  KC_ESC,       KC_A,       KC_0,       KC_E,   KC_U,    KC_I,                                  KC_D,       KC_H,       KC_T,       KC_N,       KC_S,       KC_TRNS,
