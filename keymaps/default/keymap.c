...
[0] = LAYOUT_ergodox_pretty(
  ...
  TG(4),        KC_A,       KC_O,       KC_E,   KC_U,    KC_I,                                      KC_D,   KC_H,   KC_T,   KC_N,   KC_S,   CW_TOGG,
  KC_LSFT,      KC_QUOTE,   KC_Q,       KC_J,   KC_K,    KC_X,    KC_EXLM,              KC_QUES,    KC_B,   KC_M,   KC_W,   KC_V,   KC_Z,   KC_RSFT,
  KC_NO,        KC_NO,      KC_NO,      TG(2),  TG(1),                                              KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,

                                                KC_NO,  KC_NO,                  KC_NO, KC_NO,
                                                        KC_NO,                  KC_NO,
                        LGUI_T(KC_ESC), LT(3, KC_SPC),  LCTL_T(KC_TAB),         TD(ALT_TMUX), KC_BSPC, KC_ENT
),
...
[1] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,      KC_Z,       KC_X,       KC_C,   KC_V,    KC_B,    KC_TRNS,          KC_TRNS,    KC_N,       KC_M,       KC_COMMA,   KC_DOT,     KC_SCLN,    KC_TRNS,
  KC_NO,        KC_NO,      KC_NO,      KC_NO,  KC_TRNS,                                        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,

                                                KC_NO,  KC_NO,                  KC_NO, KC_NO,
                                                        KC_NO,                  KC_NO,
                        LALT_T(KC_A),   LT(4, KC_SPC),  KC_LCTL,                KC_NO, KC_BSPC, KC_ENT
),
/* L2: General Gaming
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
